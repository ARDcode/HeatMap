package develop.heatmap.service;
...
import develop.heatmap.helper.Util;
...
public class CameraService extends Service {
    ...
    private void handleStartRecordingCommand(final Intent intent) {
        ...
        final String path = intent.getStringExtra(SELECTED_PATH);
        if (mCamera != null) {
            ...
            sh.addCallback(new SurfaceHolder.Callback() {
                ...
                public void surfaceCreated(SurfaceHolder holder) {
                    ...
                    mMediaRecorder.setOutputFile(path+ "_camera.mp4");
